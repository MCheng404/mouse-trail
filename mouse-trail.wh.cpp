...
* **Shape Trail:** Spawns hearts, stars, hexagons, circles, diamonds, triangles, flowers, pentagons, or hexagrams along the path with random velocity, rotation, gravity, configurable interval/size/count/lifetime
...
* **Lightning:** Thin bright jagged line with random branch forks
* **Feather:** Thin central shaft with angled side barbs, natural feather curve
...
* Shapes: circle, star, hexagram, heart, diamond, triangle, flower, pentagon, hexagon, or text particles
...
* **波浪曲线：** 动态波浪变形
* **形状拖尾：** 沿路径生成爱心、五角星、六边形、圆形、菱形、三角形、花朵、五边形、六芒星，带随机速度、旋转、重力，间隔/大小/数量/存活时间可调
* **双线拖尾：** 两条平行拖尾带
* **虚线拖尾：** 常量宽度分段虚线
* **螺旋拖尾：** 沿路径螺旋变形
* **闪电拖尾：** 细亮锯齿线 + 随机分支
...
* 光标吸引 + 排斥力，形成绕飞运动
* 形状：圆形、五角星、六芒星、爱心、菱形、三角形、花朵、五边形、六边形或文字粒子
